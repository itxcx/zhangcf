...
class sql_executor
{
    ...
    {
        $this->sql_executor_init($db, $charset, $sprefix, $tprefix, $log_path, $auto_match, $ignored_errors);
    }
     ...
     * @return  void
     */
    function sql_executor_init($db, $charset = 'gbk', $sprefix = 'ecs_', $tprefix = 'ecs_', $log_path = '', $auto_match = false, $ignored_errors = array())
    {
        $this->db = $db;
    ...
    function run_all($sql_str)
    {
		...
		$query_items = $this->parse_sql_str($sql_str);
