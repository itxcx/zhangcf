...
$_LANG['prev_step'] = '上一步：';
$_LANG['next_step'] = '下一步：';
$_LANG['copyright'] = '&copy; 2012-'.date('Y').' ';


/* 欢迎页 */
$_LANG['welcome_title'] = '欢迎您选用软件！';
...
$_LANG['version_msg'] = '您当前安装的版本已经是最新版本';
$_LANG['select_setup_app'] = '选择要安装的应用';
$_LANG['App_Admin'] = '应用中心';
$_LANG['App_Shop_Admin'] = '商城';
$_LANG['App_Company_Admin'] = '企业网站';
$_LANG['App_DmsAdmin_Admin'] = '结算系统';
...
$_LANG['admin_account'] = '超级管理员帐号';
$_LANG['admin_name'] = '登录帐号：';
...
$_LANG['dbname_empty_error'] = '数据库名称不能为空';
$_LANG['dbuser_empty_error'] = '数据库用户名不能为空';
$_LANG['dbport_empty_error'] = '数据库端口号不能为空';
$_LANG['cannt_create_database'] = '无法创建数据库';
$_LANG['account_empty_error'] = '登录帐号不能为空';
$_LANG['password_empty_error'] = '登录密码不能为空';
...
$_LANG['install_done_title'] = '系统安装程序 安装成功';
$_LANG['install_error_title'] = '系统安装程序 安装失败';
$_LANG['done'] = '恭喜您，系统已经成功地安装完成。<br />基于安全的考虑，请在安装完成后删除 Install 目录。';
$_LANG['go_to_view_my_site'] = '前往 首页';
$_LANG['go_to_view_control_panel'] = '前往 后台管理中心';
$_LANG['open_config_file_failed'] = '无法写入，请检查该文件是否允许写入。';
$_LANG['write_config_file_failed'] = '写入配置文件出错';
$_LANG['not_select_app'] = '未选择要安装的应用';

/* 客户端JS语言项 */
$_LANG['js_languages']['success'] = '成功';
$_LANG['js_languages']['fail'] = '失败';
$_LANG['js_languages']['db_exists'] = '这是一个已经存在的数据库，确定安装将覆盖原数据库';
...
$_LANG['js_languages']['password_short'] = '密码长度不能小于1';
...
$_LANG['timezone']['PRC']	= '中华人民共和国';
$_LANG['timezone']['Asia/Shanghai']	= '亚洲/中国/上海';
$_LANG['timezone']['Asia/Taipei']	= '亚洲/中国/台北';
$_LANG['timezone']['Asia/Chongqing']	= '亚洲/中国/重庆';
$_LANG['timezone']['Asia/Harbin']	= '亚洲/中国/哈尔滨';
$_LANG['timezone']['Asia/Urumqi']	= '亚洲/中国/乌鲁木齐';
$_LANG['timezone']['Asia/Hong_Kong']	= '亚洲/中国/香港';
$_LANG['timezone']['Asia/Macau']	= '亚洲/中国/澳门';
$_LANG['timezone']['Asia/Singapore']	= '亚洲/新加坡';
$_LANG['timezone']['Asia/Seoul']	= '亚洲/韩国/首尔';
$_LANG['timezone']['Asia/Tokyo']	= '亚洲/日本/东京';
$_LANG['timezone']['Europe/Berlin']	= '欧洲/德国/柏林';
$_LANG['timezone']['Europe/Dublin']	= '欧洲/德国/都柏林';
$_LANG['timezone']['Europe/Paris']	= '欧洲/法国/巴黎';
